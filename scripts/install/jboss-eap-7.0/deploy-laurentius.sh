...
quit () {
	echo "\nUsage:\n"
	echo "deploy-laurentius.sh --init -b [LAU_BUNDLE] -s [SERVER_HOME] -l [LAU_HOME]\n"
	echo "  --init  initialize laurentius.home and wildfly properties. "
	echo "  -s   SERVER_HOME -  path jboss home: ex.: /opt/servers/[SERVER_HOME]."
